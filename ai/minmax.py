...
def minimax(board, depth, maximizing_player, eval_fn, player_symbol):
    """
    ...
    # Get valid moves with heuristic optimization
    ...
    if maximizing_player:
        ...
        for move in valid_moves:
            ...
            score, _ = minimax(board, depth - 1, False, eval_fn, player_symbol)
        ...
        for move in valid_moves:
            ...
            # Recursively evaluate the position
            score, _ = minimax(board, depth - 1, True, eval_fn, player_symbol)
